#!/usr/bin/env python3
"""playwright_scraper.py — TikTok videos, captions and media links.

    python3 playwright_scraper.py --url nasa
    python3 playwright_scraper.py --url nasa,zachking --format both
    python3 playwright_scraper.py --url "https://www.tiktok.com/@nasa/video/7665075736742530317" --mode video
    python3 playwright_scraper.py --url 7665075736742530317,7686600539525762318 --mode video --concurrency 2
